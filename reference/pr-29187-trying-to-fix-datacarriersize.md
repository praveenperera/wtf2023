...
[Luke Dashjr](https://twitter.com/lukedashjr) - the second largest contributor - sparked a controversy by inviting Bitcoin Core to act to stop Inscriptions and other wasteful transactions from attacking the network. Luke Dashjr did so through a Pull Request, dated the 5th of January 2023. It is entitled: *"*[***Witness scripts being abused to bypass datacarriersize limit***](https://github.com/bitcoin/bitcoin/issues/29187)*"*.

The description of the Pull Request goes as follows:
