...
[Dominating OP Returns: The Impact of Omni and Veriblock on Bitcoin](https://link.springer.com/article/10.1007/s10723-020-09537-9) found that Omni/Tether accounted for 40% of `OP_RETURN` transactions between September 14, 2018, and December 31, 2019. The paper notes that Omni transactions paid more than twice the average transaction fee, making them more likely to compete with regular Bitcoin transactions for block space.

### Veriblock

[Dominating OP Returns: The Impact of Omni and Veriblock on Bitcoin](https://link.springer.com/article/10.1007/s10723-020-09537-9) also found that Veriblock accounted for 58% of `OP_RETURN` transactions during the same period. Unlike Omni, Veriblock transactions paid about 14% of the average transaction fee and were often submitted when overall Bitcoin activity was low.
