...
Discussing the **validity of the transaction is not the issue** and participants should not let the debate diverge in that direction. Spam will always be valid, the questions that should be discussed are:** ● Are these transactions willingly wasting the shared resources of the network?**
...
- [Image](https://res2.weblium.site/res/6627b42175a2700010093916/6628c976a74adc000f655442_optimized)
